...
mosquitto_pub "${MQTT_ARGS[@]}" -t "greenhouse/zones/zone1/nodes/$NODE_ID/state" -m "{\"schema_version\":\"node-state/v1\",\"timestamp\":\"2026-03-25T15:25:00Z\",\"zone_id\":\"zone1\",\"node_id\":\"$NODE_ID\",\"moisture_raw\":333,\"moisture_percent\":19,\"soil_temp_c\":24.2,\"battery_voltage\":3.91,\"battery_percent\":76,\"wifi_rssi\":-51,\"uptime_seconds\":240,\"wake_count\":4,\"ip\":\"192.168.4.99\",\"health\":\"ok\",\"last_error\":\"none\",\"publish_reason\":\"scheduled\"}"
